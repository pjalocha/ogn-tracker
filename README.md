...
<table>
  <tr>
    <td width="50%"><img src="photos/ROOK.jpg" alt="ROOK-based OGN-Tracker example build" width="100%"></td>
    <td width="50%"><img src="photos/HTIT-Tracker.jpeg" alt="HTIT-Tracker assembly example in ROOK case" width="100%"></td>
  </tr>
</table>
...
Additionally **ADS-L** and **FANET** are transmitted.
...
Reception and traffic visualization is possible: the data is being sent via BT and can be seen with applications like XCsoar.
